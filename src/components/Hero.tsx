        ...
        <div className="max-w-3xl">
          <div className="animate-fade-in">
            <div className="inline-block mb-4 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
              <span className="text-white text-sm font-medium">Trusted Healthcare Staffing Solutions</span>
            </div>
          </div>
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-8 leading-relaxed animate-fade-in-left" style={{ animationDelay: "0.2s" }}>
            Connecting healthcare facilities with qualified, compassionate professionals. 
            Available 24/7 for temporary, permanent, and emergency placements.
          </p>
          ...
          <div className="grid grid-cols-3 gap-8 mt-16 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            <div className="text-center">
              ...
              <div className="text-white/80 text-sm md:text-base">Qualified Staff</div>
            </div>
            <div className="text-center">
