...
const steps = [
  {
    ...
    title: "Contact Us",
    description:
      "Reach out via phone, email, or our online form with your staffing requirements. Our team typically responds within 30–60 minutes for urgent requests.",
  },
  {
    icon: UserCheck,
    title: "Staff Selection",
    description:
      "We carefully match qualified healthcare professionals from our vetted pool to your specific needs and requirements.",
  },
  {
    icon: Calendar,
    title: "Quick Placement",
    description:
      "Receive candidate profiles quickly, conduct interviews where required, and schedule placements — often within 24–48 hours depending on role and checks.",
  },
  {
    icon: ThumbsUp,
    title: "Ongoing Support",
    description:
      "Continuous monitoring, feedback collection, and dedicated support ensure seamless service delivery.",
  },
];
      ...
      <div className="container px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            From initial contact to ongoing support, we make healthcare staffing
            effortless
          </p>
        </div>
